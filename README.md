...
Futtasd a következő osztályt:
org.example.connect4.Connect4
Játékmenet
...
A program induláskor megkérdezi:

Szeretnél kezdőállást betölteni fájlból? (i/n)

Ha i, akkor a input.txt fájlból tölt.

input.txt formátum
6 sor, 7 karakter soronként
. → üres mező
X → gép
O → játékos
Példa:
