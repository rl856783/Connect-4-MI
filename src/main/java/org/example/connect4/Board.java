/**
 * A Connect4 játék táblájának reprezentálása.
 * Ez az osztály kezeli a tábla állapotát, a korongok elhelyezését,
 * a tábla fájlba történő mentését, illetve a fájlból való betöltését.
 */
...
public class Board {
    // A tábla mérete: 6 sor és 7 oszlop (klasszikus Connect4 szabályok szerint).
     ...
     * @param filename A fájl neve, amelyből az állapotot beolvassuk.
     */
    public void loadFromFile(String filename) {
        File file = new File(filename);
        if (file.exists()) { // Ellenőrzi, hogy a fájl létezik-e.
            try (BufferedReader reader = new BufferedReader(new FileReader(filename))) {
                for (int i = 0; i < SOROK; i++) {
                    String line = reader.readLine(); // Egy sor beolvasása.
     ...
     * @return Igaz, ha a fájl létezik, különben hamis.
     */
    ...
    /**
     * Visszaállítja a táblát az alapértelmezett üres állapotba.
     */
    public void resetBoard() {
        for (int i = 0; i < SOROK; i++) {
            Arrays.fill(board[i], ' '); // Minden mezőt üresre állít.
        }
    }
     ...
     * @param column Az ellenőrizendő oszlop száma.
     * @return Igaz, ha az oszlop teteje üres, különben hamis.
     */
